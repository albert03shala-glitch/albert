...
reacting to a specific draft reply (in Drafts, via the mail connector, or
by describing it to you in chat).
...
Update the same draft in place (via the mail connector's
create/update-draft tool) with the one-off edits plus every applicable
rule from `learnings.md`/`voice.md`. Do not send it.
